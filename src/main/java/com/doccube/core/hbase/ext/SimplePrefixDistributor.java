 ...
 */
package com.doccube.core.hbase.ext;
 ...
 * @author Alex Baranau
 */
public class SimplePrefixDistributor extends RowKeyDistributor {
  ...
  public SimplePrefixDistributor() {
  }

  public SimplePrefixDistributor(byte bucketsCount) {
