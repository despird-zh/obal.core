...
public class REntryWrapperUtils {
	 ...
	 **/
	public static Object getPrimitiveValue(EntityAttr attr, byte[] value){
	 ...
	 **/
	public static Map<String,Object> getMapValue(EntityAttr attr, Map<byte[], byte[]> cells){
	 ...
	 **/
	public static List<Object> getListValue(EntityAttr attr, List<byte[]> cells){
	 ...
	 * @return Object the list object
	 **/
	public static Set<Object> getSetValue(EntityAttr attr, Set<byte[]> cells){
	 ...
	 **/
	public static void putPrimitiveValue(Jedis jedis,String key, EntityAttr attr, Object value){
		byte[] bval = null;
	 ...
	 **/
	public static void putMapValue(Jedis jedis,String key, EntityAttr attr, Map<String,Object> mapVal){
		byte[] bval = null;
	 ...
	 **/
	public static void putListValue(Jedis jedis, String key, EntityAttr attr, List<Object> listVal){
		byte[] bval = null;
		String newkey = key + CoreConstants.KEYS_SEPARATOR + attr.getQualifier();
	 ...
	 **/
	public static void putSetValue(Jedis jedis, String key, EntityAttr attr, Set<Object> setVal){
		byte[] bval = null;
		String newkey = key + CoreConstants.KEYS_SEPARATOR  + attr.getQualifier();
